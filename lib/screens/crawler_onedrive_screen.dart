...
import 'package:personal_power_cloud/screens/crawler_dropbox_screen.dart';

class CrawlerOnedriveScreen extends StatefulWidget {
  const CrawlerOnedriveScreen({super.key});

   @override
  // ignore: library_private_types_in_public_api
  _CrawlerOnedriveScreenState createState() => _CrawlerOnedriveScreenState();
}

class _CrawlerOnedriveScreenState extends State<CrawlerOnedriveScreen> {
  ...
  Future<bool> _onWillPop(BuildContext context) async {
    Navigator.pushReplacement(
      context,
      MaterialPageRoute(builder: (context) => const CrawlerDropboxScreen()),
    );
  ...
  Widget build(BuildContext context) {
    ...
    return WillPopScope(
      onWillPop: () => _onWillPop(context), // Defina o comportamento do botão de voltar
      child: Scaffold(
        backgroundColor: Pallete.backgroundColor,
        body: SafeArea( // Adiciona o SafeArea aqui
            ...
            child: Center(
              child: Column(
                children: [
                  ...
                  buildNavigationBar(context, 'onedrive'),
