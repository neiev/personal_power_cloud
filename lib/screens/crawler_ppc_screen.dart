...
class CrawlerPpcScreen extends StatefulWidget {
  ...
  _CrawlerPpcScreenState createState() => _CrawlerPpcScreenState();
}

class _CrawlerPpcScreenState extends State<CrawlerPpcScreen> {
  ...
  Future<bool> _onWillPop(BuildContext context) async {
    Navigator.pushReplacement(
      context,
      MaterialPageRoute(builder: (context) => const CrawlerSdCardScreen()),
    );
  ...
  Widget build(BuildContext context) {
    ...
    return WillPopScope(
      onWillPop: () => _onWillPop(context), // Associando o método de navegação personalizada ao evento de voltar
      child: Scaffold(
            ...
            child: Center(
              child: Column(
                children: [
                  ...
                  buildNavigationBar(context, 'ppc'),
