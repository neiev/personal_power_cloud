...
class CrawlerSftpScreen extends StatefulWidget {
  const CrawlerSftpScreen({super.key});

  @override
  // ignore: library_private_types_in_public_api
  _CrawlerSftpScreenState createState() => _CrawlerSftpScreenState();
}

class _CrawlerSftpScreenState extends State<CrawlerSftpScreen> {
  ...
  Future<bool> _onWillPop(BuildContext context) async {
    Navigator.pushReplacement(
      context,
      MaterialPageRoute(builder: (context) => const CrawlerFtpScreen()),
    );
  ...
  Widget build(BuildContext context) {
    ...
    return WillPopScope(
      onWillPop: () => _onWillPop(context), // Adicione o controle aqui
      child: Scaffold(
            ...
            child: Center(
              child: Column(
                children: [
                  ...
                  buildNavigationBarMore(context, 'sftp'),
