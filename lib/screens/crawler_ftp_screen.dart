...
import 'package:personal_power_cloud/screens/crawler_onedrive_screen.dart';
import 'package:personal_power_cloud/widgets/search_bar.dart' as custom;

class CrawlerFtpScreen extends StatefulWidget {
  const CrawlerFtpScreen({super.key});

  @override
  // ignore: library_private_types_in_public_api
  _CrawlerFtpScreenState createState() => _CrawlerFtpScreenState();
}

class _CrawlerFtpScreenState extends State<CrawlerFtpScreen> {
  ...
  Future<bool> _onWillPop(BuildContext context) async {
    Navigator.pushReplacement(
      context,
      MaterialPageRoute(builder: (context) => const CrawlerOnedriveScreen()),
    );
  ...
  Widget build(BuildContext context) {
    ...
    return WillPopScope(
      onWillPop: () => _onWillPop(context), // Chama o método ao pressionar o botão de voltar
      child: Scaffold(
        backgroundColor: Pallete.backgroundColor,
        body: SafeArea( // Envolvendo o corpo com o SafeArea
            ...
            child: Center(
              child: Column(
                children: [
                  ...
                  buildNavigationBarMore(context, 'ftp'),
