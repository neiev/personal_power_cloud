...
class CrawlerSdCardScreen extends StatefulWidget {
  const CrawlerSdCardScreen({super.key});

  @override
  // ignore: library_private_types_in_public_api
  _CrawlerSdCardScreenState createState() => _CrawlerSdCardScreenState();
}

class _CrawlerSdCardScreenState extends State<CrawlerSdCardScreen> {
  ...
  void _saveStates() {
    _actionBarFunctions.saveStates(selectedFiles.toList());
  }

  void _deleteFiles() {
    _actionBarFunctions.deleteFiles(selectedFiles.toList(), setState);
  }
  ...
  Widget build(BuildContext context) {
    ...
    return WillPopScope(
      onWillPop: () => _onWillPop(context), // Associando a função _onWillPop
      child: Scaffold(
            ...
            child: Center(
              child: Column(
                children: [
                  ...
                  buildNavigationBar(context, 'sd_card'),
