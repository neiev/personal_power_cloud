...
class CrawlerHttpScreen extends StatefulWidget {
  const CrawlerHttpScreen({super.key});

  @override
  // ignore: library_private_types_in_public_api
  _CrawlerHttpScreenState createState() => _CrawlerHttpScreenState();
}

class _CrawlerHttpScreenState extends State<CrawlerHttpScreen> {
  ...
  Future<bool> _onWillPop(BuildContext context) async {
    Navigator.pushReplacement(
      context,
      MaterialPageRoute(builder: (context) => const CrawlerRsyncScreen()),
    );
  ...
  Widget build(BuildContext context) {
    ...
    return WillPopScope(
      onWillPop: () => _onWillPop(context), // Associa o método _onWillPop
      child: Scaffold(
            ...
            child: Center(
              child: Column(
                children: [
                  ...
                  buildNavigationBarMore(context, 'http'),
