...
class CrawlerRsyncScreen extends StatefulWidget {
  const CrawlerRsyncScreen({super.key});

  @override
  // ignore: library_private_types_in_public_api
  _CrawlerRsyncScreenState createState() => _CrawlerRsyncScreenState();
}

class _CrawlerRsyncScreenState extends State<CrawlerRsyncScreen> {
  ...
  Future<bool> _onWillPop(BuildContext context) async {
    Navigator.pushReplacement(
      context,
      MaterialPageRoute(builder: (context) => const CrawlerSftpScreen()),
    );
  ...
  Widget build(BuildContext context) {
    ...
    return WillPopScope(
      onWillPop: () => _onWillPop(context), // Intercepta o botão "voltar"
      child: Scaffold(
            ...
            child: Center(
              child: Column(
                children: [
                  ...
                  buildNavigationBarMore(context, 'rsync'),
